...
const URL = `${REACT_JS_URL_PREFIX}/baltistics.js`

ReactPageResolver.register(URL, import.meta.path)

export default function Baltistics(
  props: {
    nav: NavProps
    pathname: string
  ...
  return (
    <Body nav={props.nav} pathname={props.pathname} locale={props.locale}>
      <article>
        <h1>{props.h1}</h1>
        ...
        <p className={'baltistics__tbc'}>{props.toBeContinued}</p>
      </article>
    </Body>
  )
}
